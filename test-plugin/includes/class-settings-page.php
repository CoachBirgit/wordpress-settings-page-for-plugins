...
class Settings_Page
{
	...
	/**
	 * general method to add a field
	 * @param string $type the type of field, mapped to a method
	 * @param string $section_title the title to be displayed on the page
	 * @param string $id            an id
	 * @param string $title         the title of the field
	 * @param mixed $value         the value to prepopulate
	 */
